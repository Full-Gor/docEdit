...
import { ArrowLeft, Save, Share, Eye, Mail, User, Calendar, Send, Plus, X } from 'lucide-react-native';
...
export default function MarketingEmailTemplate() {
  ...
  const [title, setTitle] = useState('Email Marketing');
  const [company, setCompany] = useState('Mon Entreprise');
  const [emailSubject, setEmailSubject] = useState('Découvrez nos nouvelles offres !');
  const [sender, setSender] = useState('Marketing Team');
  const [date, setDate] = useState('15/01/2024');
  const [audience, setAudience] = useState('Clients existants');
  const [isPreview, setIsPreview] = useState(false);
  
  const [sections, setSections] = useState([
    { id: 1, title: 'En-tête', content: 'Logo et titre accrocheur', icon: '📧' },
    { id: 2, title: 'Introduction', content: 'Message d\'accueil personnalisé', icon: '👋' },
    { id: 3, title: 'Offre principale', content: 'Promotion ou annonce importante', icon: '🎯' },
    { id: 4, title: 'Call-to-action', content: 'Bouton d\'action clair', icon: '✅' },
    { id: 5, title: 'Pied de page', content: 'Informations légales et désinscription', icon: '📄' },
  ]);
  ...
  useEffect(() => {
    if (params.savedDocument) {
      try {
        ...
        setEmailSubject(savedDoc.emailSubject || emailSubject);
        setSender(savedDoc.sender || sender);
        setDate(savedDoc.date || date);
        setAudience(savedDoc.audience || audience);
  ...
  const saveDocument = async () => {
    try {
      ...
      Alert.alert(
        'Sauvegarde réussie',
        'Votre email marketing a été sauvegardé localement.',
        [{ text: 'OK' }]
      );
      ...
      const pdfData: PDFData = {
        ...
        content: `
          ...
          <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <p><strong>Template:</strong> marketing-email.tsx</p>
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <Text style={styles.previewTitle}>Aperçu de l'Email</Text>
          <View style={styles.sparklesIcon}>
            <Mail size={20} color="#FCD34D" />
          </View>
        </LinearGradient>
        ...
        <ScrollView style={styles.previewContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.coverContent}>
              ...
              <View style={styles.emailDetails}>
                <View style={styles.detailItem}>
                  ...
                  <Text style={styles.detailText}>{sender}</Text>
                </View>
                <View style={styles.detailItem}>
                ...
                <View style={styles.detailItem}>
                  ...
                  <Text style={styles.detailText}>{audience}</Text>
                </View>
              </View>
            </View>
          </LinearGradient>
          ...
          <View style={styles.emailSection}>
            <Text style={styles.sectionTitle}>Structure de l'Email</Text>
          ...
          <View style={styles.emailFooter}>
            ...
            <Text style={styles.footerSubtext}>Email marketing généré avec engagement</Text>
          </View>
        </ScrollView>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerTitle}>Créer un Email Marketing</Text>
      ...
      <ScrollView style={styles.editorContent} showsVerticalScrollIndicator={false}>
        <View style={styles.editorCard}>
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              <Text style={styles.fieldLabel}>Titre de l'email</Text>
          ...
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              ...
              <Text style={styles.fieldHint}>Ligne d'objet accrocheuse</Text>
            </View>
            <TextInput
              style={styles.textInput}
              value={emailSubject}
          ...
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              ...
              <Text style={styles.fieldHint}>Nom de l'expéditeur</Text>
            </View>
            <TextInput
              style={styles.textInput}
              value={sender}
          ...
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              ...
              <Text style={styles.fieldHint}>Date prévue d'envoi</Text>
            </View>
            <TextInput
              style={styles.textInput}
              value={date}
          ...
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              ...
              <Text style={styles.fieldHint}>Segment de destinataires</Text>
            </View>
            <TextInput
              style={styles.textInput}
              value={audience}
            ...
            <View key={section.id} style={styles.sectionEditor}>
              ...
              <View style={styles.formSection}>
                ...
                <TextInput
                  ...
                  placeholder="Ex: Logo et titre accrocheur..."
                  placeholderTextColor="#94A3B8"
                  multiline
                  numberOfLines={4}
        ...
        <View style={styles.featuresCard}>
          ...
          {[
            { icon: '📧', title: 'Structure Email', desc: 'Sections organisées' },
            { icon: '🎯', title: 'Call-to-Action', desc: 'Boutons d\'action clairs' },
            { icon: '📊', title: 'Personnalisation', desc: 'Contenu adapté' },
            { icon: '📱', title: 'Responsive', desc: 'Compatible mobile' },
            { icon: '📈', title: 'Suivi Performance', desc: 'Métriques d\'ouverture' },
          ].map((feature, index) => (
