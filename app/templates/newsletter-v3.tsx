...
export default function NewsletterV3Template() {
  const params = useLocalSearchParams();
  const [title, setTitle] = useState('Newsletter Mensuelle');
  const [company, setCompany] = useState('Mon Entreprise');
  const [introduction, setIntroduction] = useState('Découvrez nos dernières actualités...');
  ...
  // State variables pour les articles
  const [newsArticles, setNewsArticles] = useState([
    { id: 1, title: 'Nouveau Produit', desc: 'Lancement révolutionnaire', icon: Video, gradient: ['#667EEA', '#764BA2'] },
    { id: 2, title: 'Événement Corporate', desc: 'Soirée de gala annuelle', icon: Image, gradient: ['#F093FB', '#F5576C'] },
    { id: 3, title: 'Interview CEO', desc: 'Entretien exclusif', icon: Mic, gradient: ['#4FACFE', '#00F2FE'] },
    { id: 4, title: 'Résultats Q4', desc: 'Performance exceptionnelle', icon: Camera, gradient: ['#FA709A', '#FEE140'] },
  ]);
  ...
  const updateArticle = (id: number, field: 'title' | 'desc', value: string) => {
      ...
      const pdfData: PDFData = {
        ...
        content: `
          ...
          <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <p><strong>Template:</strong> newsletter-v3.tsx</p>
      ...
      <SafeAreaView style={[styles.container, isDarkMode && styles.containerDark]}>
        ...
        <BlurView intensity={80} style={styles.floatingHeader}>
          ...
          <View style={styles.floatingTitle}>
            ...
            <Text style={[styles.floatingTitleText, isDarkMode && styles.textDark]}>Prévisualisation Newsletter</Text>
          </View>
        ...
        >
          ...
          >
            <Animated.View style={[styles.heroContent, { opacity: fadeAnim }]}>
              ...
              <Text style={[styles.heroYear, isDarkMode && styles.textDark]}>NEWSLETTER</Text>
              ...
              <View style={styles.heroStats}>
                <View style={styles.heroStatItem}>
                  <Text style={styles.heroStatNumber}>{newsArticles.length}</Text>
                  <Text style={styles.heroStatLabel}>Articles</Text>
                </View>
                <View style={styles.heroStatDivider} />
                <View style={styles.heroStatItem}>
                  <Text style={styles.heroStatNumber}>Mensuel</Text>
                  <Text style={styles.heroStatLabel}>Édition</Text>
                </View>
                <View style={styles.heroStatDivider} />
                <View style={styles.heroStatItem}>
                ...
                <View style={[styles.messageInner, isDarkMode && styles.messageInnerDark]}>
                  ...
                  <View style={styles.messageAuthor}>
                    <View style={styles.authorAvatar}>
                      <Text style={styles.authorInitial}>NL</Text>
                    </View>
                    <View>
                      <Text style={[styles.authorName, isDarkMode && styles.textDark]}>Équipe Newsletter</Text>
          ...
          <View style={[styles.achievementsStackSection, isDarkMode && styles.achievementsStackSectionDark]}>
            <Text style={[styles.sectionTitleFuture, isDarkMode && styles.textDark]}>Articles du Mois</Text>
                  ...
                  <Animated.View
                    ...
                    style={[
                      styles.stackCard,
                      {
                        ...
                        zIndex: newsArticles.length - index,
                      }
                    ]}
                  >
                    <LinearGradient
                    ...
                    >
                      <View style={styles.stackCardContent}>
                        ...
                        <Text style={styles.stackCardTitle}>{article.title}</Text>
                        <Text style={styles.stackCardDesc}>{article.desc}</Text>
          ...
          >
            ...
            <Text style={styles.footerTagline}>Newsletter mensuelle • Restez connecté</Text>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <BlurView intensity={100} style={styles.headerGlass}>
        ...
        <View style={styles.headerCenter}>
          <Music size={20} color="#8B5CF6" />
          <Text style={styles.headerTitleGlass}>Éditeur Newsletter</Text>
        </View>
      ...
      <ScrollView style={styles.editorScroll} showsVerticalScrollIndicator={false}>
        ...
        >
          {['Général', 'Contenu', 'Articles', 'Design'].map((section, index) => (
            <TouchableOpacity
              key={section}
          ...
          >
            <View style={styles.cardInner}>
              <View style={styles.cardHeader}>
                ...
                <Text style={styles.cardHeaderTitle}>Informations Newsletter</Text>
              </View>

              <View style={styles.inputGroupFuture}>
                <Text style={styles.inputLabelFuture}>Titre de la Newsletter</Text>
              ...
              <View style={styles.inputGroupFuture}>
                <Text style={styles.inputLabelFuture}>Message d'Introduction</Text>
                <View style={styles.textAreaWrapper}>
                  <TextInput
                    style={styles.textAreaFuture}
                    value={introduction}
                    onChangeText={setIntroduction}
                    placeholder="Introduction de votre newsletter..."
                    placeholderTextColor="#94A3B8"
                    multiline
                    numberOfLines={6}
        ...
        <View style={styles.achievementsTimeline}>
          <View style={styles.timelineHeader}>
            <Text style={styles.sectionTitleEditor}>Articles Newsletter</Text>
            <TouchableOpacity onPress={addArticle} style={styles.addButtonFuture}>
              <LinearGradient
                colors={['#8B5CF6', '#6366F1']}
          ...
          {newsArticles.map((article, index) => {
            const Icon = article.icon;
            return (
              <View key={article.id} style={styles.timelineItemEdit}>
                ...
                <View style={styles.timelineCard}>
                  ...
                  <View style={styles.timelineInputs}>
                    ...
                    <TextInput
                      ...
                      value={article.desc}
                      onChangeText={(value) => updateArticle(article.id, 'desc', value)}
        ...
        <View style={styles.featuresGrid}>
          <Text style={styles.sectionTitleEditor}>Capacités Newsletter</Text>
          
          <View style={styles.featuresRow}>
            {[
              { icon: Video, title: 'Vidéo Intégrée', desc: 'Contenu multimédia', color: '#FBBF24' },
              { icon: Image, title: 'Images HD', desc: 'Visuels professionnels', color: '#10B981' },
              { icon: Mic, title: 'Podcast', desc: 'Audio intégré', color: '#3B82F6' },
              { icon: Play, title: 'Lecture Auto', desc: 'Expérience fluide', color: '#8B5CF6' },
            ].map((feature, index) => {
