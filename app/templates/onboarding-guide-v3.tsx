...
export default function OnboardingGuideV3Template() {
  const params = useLocalSearchParams();
  const [title, setTitle] = useState('Guide d\'Accueil');
  const [company, setCompany] = useState('Mon Entreprise');
  const [welcomeMessage, setWelcomeMessage] = useState('Bienvenue dans notre équipe...');
  ...
  const [onboardingSteps, setOnboardingSteps] = useState([
    { id: 1, title: 'Présentation Équipe', desc: 'Rencontre avec les collègues', icon: Video, gradient: ['#667EEA', '#764BA2'] },
    { id: 2, title: 'Formation Produit', desc: 'Découverte des outils', icon: Image, gradient: ['#F093FB', '#F5576C'] },
    { id: 3, title: 'Processus RH', desc: 'Administration et procédures', icon: Mic, gradient: ['#4FACFE', '#00F2FE'] },
    { id: 4, title: 'Intégration Culture', desc: 'Valeurs et environnement', icon: Camera, gradient: ['#FA709A', '#FEE140'] },
  ]);
  ...
  const updateStep = (id: number, field: 'title' | 'desc', value: string) => {
      ...
      const pdfData: PDFData = {
        ...
        content: `
          ...
          <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <p><strong>Template:</strong> onboarding-guide-v3.tsx</p>
      ...
      <SafeAreaView style={[styles.container, isDarkMode && styles.containerDark]}>
        ...
        <BlurView intensity={80} style={styles.floatingHeader}>
          ...
          <View style={styles.floatingTitle}>
            ...
            <Text style={[styles.floatingTitleText, isDarkMode && styles.textDark]}>Prévisualisation Onboarding</Text>
          </View>
        ...
        >
          ...
          >
            <Animated.View style={[styles.heroContent, { opacity: fadeAnim }]}>
              ...
              <Text style={[styles.heroYear, isDarkMode && styles.textDark]}>ONBOARDING</Text>
              ...
              <View style={styles.heroStats}>
                <View style={styles.heroStatItem}>
                  <Text style={styles.heroStatNumber}>{onboardingSteps.length}</Text>
                  <Text style={styles.heroStatLabel}>Étapes</Text>
                </View>
                <View style={styles.heroStatDivider} />
                <View style={styles.heroStatItem}>
                  <Text style={styles.heroStatNumber}>Jour 1</Text>
                  <Text style={styles.heroStatLabel}>Début</Text>
                </View>
                <View style={styles.heroStatDivider} />
                <View style={styles.heroStatItem}>
            ...
            >
              ...
              >
                <View style={[styles.messageInner, isDarkMode && styles.messageInnerDark]}>
                  ...
                  <Text style={[styles.messageText, isDarkMode && styles.textDark]}>{welcomeMessage}</Text>
                  <View style={styles.messageAuthor}>
                    <View style={styles.authorAvatar}>
                      <Text style={styles.authorInitial}>RH</Text>
                    </View>
                    <View>
                      <Text style={[styles.authorName, isDarkMode && styles.textDark]}>Équipe RH</Text>
                      <Text style={styles.authorTitle}>Ressources Humaines</Text>
                    </View>
                  </View>
                </View>
              </LinearGradient>
          ...
          {/* Étapes d'Intégration Stack */}
          <View style={[styles.achievementsStackSection, isDarkMode && styles.achievementsStackSectionDark]}>
            <Text style={[styles.sectionTitleFuture, isDarkMode && styles.textDark]}>Étapes d'Intégration</Text>
                  ...
                  <Animated.View
                    ...
                    style={[
                      styles.stackCard,
                      {
                        ...
                        zIndex: onboardingSteps.length - index,
                      }
                    ]}
                  >
                    <LinearGradient
                    ...
                    >
                      <View style={styles.stackCardContent}>
                        ...
                        <Text style={styles.stackCardTitle}>{step.title}</Text>
                        <Text style={styles.stackCardDesc}>{step.desc}</Text>
          ...
          >
            ...
            <Text style={styles.footerTagline}>Guide d'accueil • Intégration réussie</Text>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <BlurView intensity={100} style={styles.headerGlass}>
        ...
        <View style={styles.headerCenter}>
          <Play size={20} color="#8B5CF6" />
          <Text style={styles.headerTitleGlass}>Éditeur Onboarding</Text>
        </View>
      ...
      <ScrollView style={styles.editorScroll} showsVerticalScrollIndicator={false}>
        ...
        >
          {['Général', 'Contenu', 'Étapes', 'Design'].map((section, index) => (
            <TouchableOpacity
              key={section}
          ...
          >
            <View style={styles.cardInner}>
              <View style={styles.cardHeader}>
                ...
                <Text style={styles.cardHeaderTitle}>Informations Onboarding</Text>
              </View>

              <View style={styles.inputGroupFuture}>
                <Text style={styles.inputLabelFuture}>Titre du Guide</Text>
                <View style={styles.inputWrapper}>
                  <TextInput
                    style={styles.inputFuture}
                    value={title}
                    onChangeText={setTitle}
                    placeholder="Ex: Guide d'Accueil 2024"
              ...
              <View style={styles.inputGroupFuture}>
                <Text style={styles.inputLabelFuture}>Message de Bienvenue</Text>
        ...
        <View style={styles.achievementsTimeline}>
          <View style={styles.timelineHeader}>
            <Text style={styles.sectionTitleEditor}>Étapes d'Onboarding</Text>
            <TouchableOpacity onPress={addStep} style={styles.addButtonFuture}>
              <LinearGradient
                colors={['#8B5CF6', '#6366F1']}
          ...
          {onboardingSteps.map((step, index) => {
            const Icon = step.icon;
            return (
              <View key={step.id} style={styles.timelineItemEdit}>
                ...
                <View style={styles.timelineCard}>
                  ...
                  <View style={styles.timelineInputs}>
                    ...
                    <TextInput
                      ...
                      value={step.desc}
                      onChangeText={(value) => updateStep(step.id, 'desc', value)}
        ...
        <View style={styles.featuresGrid}>
          <Text style={styles.sectionTitleEditor}>Capacités Onboarding</Text>
          
          <View style={styles.featuresRow}>
            {[
              { icon: Video, title: 'Vidéos Formation', desc: 'Tutoriels interactifs', color: '#FBBF24' },
              { icon: Image, title: 'Visuels Guide', desc: 'Supports visuels', color: '#10B981' },
              { icon: Mic, title: 'Audio Guide', desc: 'Instructions vocales', color: '#3B82F6' },
              { icon: Play, title: 'Progression', desc: 'Suivi automatique', color: '#8B5CF6' },
            ].map((feature, index) => {
