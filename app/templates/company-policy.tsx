...
import { ArrowLeft, Save, Share, Eye, FileText, User, Calendar, Shield, Plus, X } from 'lucide-react-native';
import { router, useLocalSearchParams } from 'expo-router';
import AsyncStorage from '@react-native-async-storage/async-storage';

const { width } = Dimensions.get('window');

export default function CompanyPolicyTemplate() {
  const params = useLocalSearchParams();
  const [title, setTitle] = useState('Politique d\'Entreprise');
  const [company, setCompany] = useState('Mon Entreprise');
  const [policyTitle, setPolicyTitle] = useState('Politique de Télétravail');
  ...
  const [sections, setSections] = useState([
    { id: 1, title: 'Objectif', content: 'Définir les règles de télétravail', icon: '🎯' },
    { id: 2, title: 'Champ d\'application', content: 'Tous les employés éligibles', icon: '👥' },
    { id: 3, title: 'Conditions', content: 'Autorisation préalable requise', icon: '✅' },
    { id: 4, title: 'Procédures', content: 'Demande via formulaire en ligne', icon: '📋' },
    { id: 5, title: 'Sanctions', content: 'Non-respect des règles', icon: '⚠️' },
  ]);
  ...
  useEffect(() => {
    if (params.savedDocument) {
      try {
        ...
        setPolicyTitle(savedDoc.policyTitle || policyTitle);
  ...
  const saveDocument = async () => {
    try {
      ...
      Alert.alert(
        'Sauvegarde réussie',
        'Votre politique d\'entreprise a été sauvegardée localement.',
        [{ text: 'OK' }]
      );
      ...
      const pdfData: PDFData = {
        ...
        content: `
          ...
          <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <p><strong>Template:</strong> company-policy.tsx</p>
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <Text style={styles.previewTitle}>Aperçu de la Politique</Text>
        ...
        <ScrollView style={styles.previewContent} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <View style={styles.coverContent}>
              ...
              <Text style={styles.policySubtitle}>{policyTitle}</Text>
          ...
          <View style={styles.policySection}>
            <Text style={styles.sectionTitle}>Sections de la Politique</Text>
          ...
          <View style={styles.policyFooter}>
            ...
            <Text style={styles.footerSubtext}>Politique générée avec rigueur</Text>
          </View>
        </ScrollView>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerTitle}>Créer une Politique d'Entreprise</Text>
      ...
      <ScrollView style={styles.editorContent} showsVerticalScrollIndicator={false}>
        <View style={styles.editorCard}>
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              <Text style={styles.fieldLabel}>Titre de la politique</Text>
            ...
            <TextInput
              ...
              placeholder="Ex: Politique d'Entreprise"
          ...
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              <Text style={styles.fieldLabel}>Nom de la politique</Text>
              <Text style={styles.fieldHint}>Titre spécifique de la politique</Text>
            </View>
            <TextInput
              style={styles.textInput}
              value={policyTitle}
          ...
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              ...
              <Text style={styles.fieldHint}>Service responsable</Text>
            </View>
            <TextInput
              style={styles.textInput}
              value={author}
          ...
          <View style={styles.formSection}>
            <View style={styles.labelContainer}>
              ...
              <Text style={styles.fieldHint}>Date de mise en vigueur</Text>
            </View>
            <TextInput
              style={styles.textInput}
              value={date}
            ...
            <View key={section.id} style={styles.sectionEditor}>
              ...
              <View style={styles.formSection}>
                ...
                <TextInput
                  ...
                  placeholder="Ex: Définir les règles de télétravail..."
                  placeholderTextColor="#94A3B8"
                  multiline
                  numberOfLines={4}
        ...
        <View style={styles.featuresCard}>
          ...
          {[
            { icon: '📋', title: 'Politique Structurée', desc: 'Format officiel et clair' },
            { icon: '⚖️', title: 'Sections Détaillées', desc: 'Organisation logique' },
            { icon: '📅', title: 'Versioning', desc: 'Suivi des versions' },
            { icon: '🔒', title: 'Sécurité', desc: 'Documentation officielle' },
            { icon: '📝', title: 'Conformité', desc: 'Respect des normes' },
          ].map((feature, index) => (
