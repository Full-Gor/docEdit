...
export default function PressReleaseV5Template() {
    ...
    const [contact, setContact] = useState('Contact presse');
    const [introduction, setIntroduction] = useState('Introduction du communiqué...');
    ...
    useEffect(() => {
        if (params.savedDocument) {
            try {
                ...
                setContact(savedDoc.contact || contact);
    ...
    const saveDocument = async () => {
        try {
            ...
            Alert.alert('Document Sauvegardé', 'Communiqué de presse enregistré avec succès.', [{ text: 'OK' }]);
        } catch (error) {
            ...
            <SafeAreaView style={styles.previewContainer}>
                ...
                <ScrollView style={styles.previewScroll} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.previewContent}>
                        ...
                        <Text style={styles.previewContact}>Contact : {contact}</Text>
                        ...
                        <View style={styles.customCodeZone}>
                            ...
                            <Text style={styles.customCodeDescription}>
                                Intégrez ici votre code personnalisé pour le communiqué de presse v5
                            </Text>
                        </View>
                    </View>
                </ScrollView>
        ...
        <SafeAreaView style={styles.editorContainer}>
            ...
            >
                ...
                <View style={styles.headerCenter}>
                    <Text style={styles.headerTitle}>Communiqué de Presse V5</Text>
                </View>
                ...
                <View style={styles.basicInfoSection}>
                    ...
                    <View style={styles.inputField}>
                        ...
                        <TextInput
                            ...
                            placeholder="Date du communiqué..."
                            placeholderTextColor="#9CA3AF"
                        />
                    </View>

                    <View style={styles.inputField}>
                        <Text style={styles.inputLabel}>Contact Presse</Text>
                        <TextInput
                            style={styles.professionalInput}
                            value={contact}
                            onChangeText={setContact}
                            placeholder="Contact presse..."
                            placeholderTextColor="#9CA3AF"
                        />
                    </View>
                    ...
                    <View style={styles.inputField}>
                        ...
                        <TextInput
                            ...
                            placeholder="Introduction du communiqué..."
                            placeholderTextColor="#9CA3AF"
                            multiline
                            numberOfLines={4}
                        />
