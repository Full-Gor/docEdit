...
export default function NewsletterV5Template() {
    ...
    const [editor, setEditor] = useState('Rédacteur en chef');
    const [introduction, setIntroduction] = useState('Introduction de la newsletter...');
    ...
    const saveDocument = async () => {
        try {
            ...
            Alert.alert('Document Sauvegardé', 'Newsletter enregistrée avec succès.', [{ text: 'OK' }]);
        } catch (error) {
            ...
            <SafeAreaView style={styles.previewContainer}>
                ...
                <ScrollView style={styles.previewScroll} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.previewContent}>
                        ...
                        <Text style={styles.previewEditor}>Rédacteur : {editor}</Text>
                        ...
                        <View style={styles.customCodeZone}>
                            ...
                            <Text style={styles.customCodeDescription}>
                                Intégrez ici votre code personnalisé pour la newsletter v5
                            </Text>
                        </View>
                    </View>
                </ScrollView>
        ...
        <SafeAreaView style={styles.editorContainer}>
            ...
            >
                ...
                <View style={styles.headerCenter}>
                    <Text style={styles.headerTitle}>Newsletter V5</Text>
                </View>
                ...
                <View style={styles.basicInfoSection}>
                    ...
                    <View style={styles.inputField}>
                        ...
                        <TextInput
                            ...
                            placeholder="Date de la newsletter..."
                            placeholderTextColor="#9CA3AF"
                        />
                    </View>

                    <View style={styles.inputField}>
                        <Text style={styles.inputLabel}>Rédacteur</Text>
                        <TextInput
                            style={styles.professionalInput}
                            value={editor}
